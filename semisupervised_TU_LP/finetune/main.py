...
parser.add_argument('--gamma_joao', type=str, default="0.1")
parser.add_argument('--gamma_ib', type=str, default="0.1")
...
if __name__ == '__main__':
    ...
    result_feat = args.pretrain_lr + '_' + args.gamma + '_' + args.pretrain_epoch + '_' + args.suffix
