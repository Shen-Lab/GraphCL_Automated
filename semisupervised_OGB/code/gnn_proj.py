...
class GNN(torch.nn.Module):
    ...
    def __init__(self, num_vocab, max_seq_len, node_encoder, num_layer = 5, emb_dim = 300, 
        ...
        self.proj_head = torch.nn.ModuleList([torch.nn.Sequential(torch.nn.Linear(self.emb_dim, self.emb_dim), torch.nn.ReLU(inplace=True), torch.nn.Linear(self.emb_dim, self.emb_dim)) for _ in range(5)])
